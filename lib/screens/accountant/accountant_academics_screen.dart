...
class AccountantAcademicsScreen extends StatefulWidget {
  ...
  @override
  State<AccountantAcademicsScreen> createState() =>
      _AccountantAcademicsScreenState();
}
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        ...
                        _buildTag('Activity'),
                        const SizedBox(width: 8),
                        if (classInfo['category'] == 'Secondary')
                          _buildTag('Lab')
                        else
                          _buildTag('Books'),
                      ],
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  '${classInfo['class'].toString().toUpperCase()} • ACADEMIC YEAR 2026-27',
                                  style: const TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xFF64748B),
