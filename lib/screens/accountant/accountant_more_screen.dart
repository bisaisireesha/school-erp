...
class _AccountantMoreScreenState extends State<AccountantMoreScreen> {
  ...
  Widget build(BuildContext context) {
    final filteredActions = _quickActions.where((a) {
      ...
      return (a['title'] as String).toLowerCase().contains(
                          ...
                          return GestureDetector(
                            onTap: () {
                              if (item['key'] == 'Academics') {
                                ...
                                MainLayout.pushSubScreen(
                                  context,
                                  AccountantSalaryStructureScreen(
                                    onBack: () =>
                                        MainLayout.popSubScreen(context),
                                  ),
                                );
                                ...
                                MainLayout.pushSubScreen(
                                  context,
                                  AccountantFinancialSummaryScreen(
                                    onBack: () =>
                                        MainLayout.popSubScreen(context),
                                  ),
                                );
