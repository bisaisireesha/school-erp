...
class AccountantHostelFeeScreen extends StatefulWidget {
  final VoidCallback onBack;
  const AccountantHostelFeeScreen({super.key, required this.onBack});

  @override
  State<AccountantHostelFeeScreen> createState() =>
      _AccountantHostelFeeScreenState();
}

class _AccountantHostelFeeScreenState extends State<AccountantHostelFeeScreen> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    final filteredClasses = _classes.where((c) {
      if (_selectedFilter == 1 && c['category'] != 'Boys Hostel') return false;
      if (_selectedFilter == 2 && c['category'] != 'Girls Hostel') return false;

      if (_searchQuery.isEmpty) return true;
      final q = _searchQuery.toLowerCase();
      final block = (c['block'] as String?) ?? '';
      final feeHead = (c['feeHead'] as String?) ?? '';
      return block.toLowerCase().contains(q) || feeHead.toLowerCase().contains(q);
    }).toList();
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          _buildFilterButton(1, 'Boys Hostel', LucideIcons.baby),
          _buildFilterButton(2, 'Girls Hostel', LucideIcons.backpack),
        ],
      ),
    );
  }
  ...
  Widget _buildClassCard(Map<String, dynamic> classInfo) {
    ...
    if (classInfo['category'] == 'Boys Hostel') {
      primaryColor = const Color(0xFF0EA5E9); // Light Blue
      bgColor = const Color(0xFFE0F2FE);
      icon = LucideIcons.baby;
    } else if (classInfo['category'] == 'Girls Hostel') {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 2),
                      Text(
                        '${classInfo['category']} • ${classInfo['room']}',
                        style: const TextStyle(
                          fontSize: 12,
                          color: Color(0xFF64748B),
                          fontWeight: FontWeight.w500,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      ...
                      _buildTag('Activity'),
                      const SizedBox(width: 8),
                      if (classInfo['category'] == 'Staff Quarters')
                        _buildTag('Lab')
                      else
                        _buildTag('Books'),
                    ],
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${classInfo['category']} • ${classInfo['room']} • Academic Year 2026-27 • Click a student to open payment analytics',
                                          style: const TextStyle(
                                            fontSize: 13,
                                            color: Color(0xFF64748B),
                                            fontWeight: FontWeight.w500,
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  '${classInfo['block'].toString().toUpperCase()} • ACADEMIC YEAR 2026-27',
                                  style: const TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xFF64748B),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                'Select the format you want to export the roster as.',
              ...
              _buildExportOption(
                ...
                LucideIcons.table,
                'Excel (.xlsx)',
                'Detailed spreadsheet with all columns',
                const Color(0xFF16A34A),
              ),
              const SizedBox(height: 12),
              _buildExportOption(
