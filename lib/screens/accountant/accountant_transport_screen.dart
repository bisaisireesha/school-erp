...
class AccountantTransportScreen extends StatefulWidget {
  ...
  @override
  State<AccountantTransportScreen> createState() =>
      _AccountantTransportScreenState();
}
...
class _AccountantTransportScreenState extends State<AccountantTransportScreen> {
  ...
  final List<Map<String, dynamic>> _routes = [
    {
      'route': 'Route 01 - Downtown',
      'vehicle': 'Bus AP09-1234',
      'collected': '₹4,50,000',
      'pending': '₹1,20,000',
      'students': 45,
    },
    {
      'route': 'Route 02 - North Hill',
      'vehicle': 'Van AP09-5678',
      'collected': '₹3,20,000',
      'pending': '₹45,000',
      'students': 28,
    },
    {
      'route': 'Route 03 - East End',
      'vehicle': 'Bus AP09-9012',
      'collected': '₹5,10,000',
      'pending': '₹2,10,000',
      'students': 52,
    },
    {
      'route': 'Route 04 - West side',
      'vehicle': 'Bus AP09-3456',
      'collected': '₹3,80,000',
      'pending': '₹90,000',
      'students': 40,
    },
    {
      'route': 'Route 05 - Suburbs',
      'vehicle': 'Van AP09-7890',
      'collected': '₹2,10,000',
      'pending': '₹30,000',
      'students': 22,
    },
    {
      'route': 'Route 06 - South City',
      'vehicle': 'Bus AP09-2345',
      'collected': '₹4,90,000',
      'pending': '₹1,50,000',
      'students': 48,
    },
  ...
  Widget build(BuildContext context) {
    final filteredRoutes = _routes
        .where(
          (r) =>
              r['route'].toString().toLowerCase().contains(
                _searchQuery.toLowerCase(),
              ) ||
              r['vehicle'].toString().toLowerCase().contains(
                _searchQuery.toLowerCase(),
              ),
        )
        .toList();
  ...
  Widget _buildRouteCard(Map<String, dynamic> route) {
    final routeName = route['route'].toString().split(' - ').length > 1
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 12),
                Expanded(
                  child: _buildGridItem('Riders', route['students'].toString()),
                ),
              ],
            ),
            const SizedBox(height: 12),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  '${route['route'].toString().toUpperCase()} • ACADEMIC YEAR 2026-27',
                                  style: const TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xFF64748B),
