...
class AccountantInvoicesScreen extends StatefulWidget {
  ...
  @override
  State<AccountantInvoicesScreen> createState() =>
  ...
  Future<void> _loadInvoices() async {
    try {
      final String response = await rootBundle.loadString(
        'assets/mock/accountant_invoices.json',
      );
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            const Text(
                              'This creates an incoming receivable.',
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                                color: Color(0xFF1E1E2D),
                      ...
                      onPressed: () {
                        ...
                        setState(() {
                          _invoices.insert(0, {
                            ...
                            'rollNo': rollNoCtrl.text.isEmpty
                                ? 'N/A'
                                : rollNoCtrl.text,
                            'grade': classCtrl.text.isEmpty
                                ? 'N/A'
                                : classCtrl.text,
                            'feeHead': feeHeadCtrl.text.isEmpty
                                ? 'General'
                                : feeHeadCtrl.text,
