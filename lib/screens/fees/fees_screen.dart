...
class FeesScreen extends StatefulWidget {
  ...
  const FeesScreen({super.key, this.onBack});
...
class _FeesScreenState extends State<FeesScreen> {
  ...
  Future<void> _loadData() async {
    final String jsonString = await rootBundle.loadString(
      'assets/mock/fees_overview.json',
    );
    setState(() {
            ...
            return pw.Center(
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    'Generated by Parent App on ${DateTime.now().toString().split('.')[0]}',
    ...
    return ValueListenableBuilder<String>(
      ...
      builder: (context, searchQuery, child) {
        ...
        if (query.isNotEmpty) {
          ...
          final upcoming = (data['upcomingPayments'] as List? ?? [])
              .where(
                (p) =>
                ...
                child: Column(
                  ...
                  children: [
                    if (isSuccess) ...[
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'You have successfully paid ${paymentAmountType == 'full' ? '₹$amount' : '₹$customAmount'}.',
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            'Pay ${paymentAmountType == 'full' ? '₹$amount' : (customAmount.isEmpty ? '₹0' : '₹$customAmount')}',
                            style: const TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: Color(0xFF1E1E2D),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            Future.delayed(const Duration(seconds: 2), () {
                              if (mounted) {
                                setState(() {
                                  String amt = paymentAmountType == 'full'
                                      ? amount
                                      : customAmount;
                                  ...
                                  String formattedAmt = newAmt.toStringAsFixed(
                                    0,
                                  );
                                  if (formattedAmt.length > 3) {
                                    formattedAmt =
                                        '${formattedAmt.substring(0, formattedAmt.length - 3)},${formattedAmt.substring(formattedAmt.length - 3)}';
                                  }
                                  _mockData!['outstandingBalance']['amount'] =
                                      formattedAmt;
                                });
