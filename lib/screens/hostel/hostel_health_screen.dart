...
class _HostelHealthScreenState extends State<HostelHealthScreen> {
  ...
  Future<void> _loadHealthRecords() async {
    try {
      final String response = await rootBundle.loadString(
        'assets/mock/hostel_health.json',
      );
  ...
  Widget build(BuildContext context) {
    ...
    int onMedication = _healthRecords
        .where((r) => r['status'] == 'On Medication')
        .length;
    int recoveredWeek = _healthRecords
        .where((r) => r['status'] == 'Recovered')
        .length;
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Search student, issue, roll no...',
  ...
  Widget _buildHealthCard(Map<String, dynamic> record) {
    ...
    switch (severity) {
      case 'High':
        ...
        sevColor = const Color(0xFFE11D48);
        break;
      case 'Moderate':
        ...
        break;
      case 'Low':
        sevBg = const Color(0xFFDCFCE7);
        sevColor = const Color(0xFF16A34A);
        break;
      default:
        sevBg = const Color(0xFFF1F5F9);
        sevColor = const Color(0xFF64748B);
    }
              ...
              children: [
                ...
                PopupMenuButton<String>(
                  ...
                  onSelected: (val) {
                    ...
                    if (val == 'recover') {
                      setState(() => record['status'] = 'Recovered');
                    }
                    if (val == 'admit') {
                      setState(() => record['status'] = 'Under Observation');
                    }
                    if (val == 'refer') {
                      setState(() => record['status'] = 'Referred to Hospital');
                    }
                  },
                  itemBuilder: (context) => [
                    const PopupMenuItem(
  ...
  void _showEditModal(Map<String, dynamic> record) {
    final studentCtrl = TextEditingController(
      text: record['studentName'] as String,
    );
    ...
    final complaintCtrl = TextEditingController(
      text: record['issue'] as String,
    );
    final treatmentCtrl = TextEditingController(
      text: record['medication'] as String,
    );
            ...
            child: Column(
              ...
              children: [
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Update the details of the medical issue.',
                            style: TextStyle(
                              fontSize: 13,
                              color: Color(0xFF64748B),
                            ),
                ...
                Row(
                  children: [
                    Expanded(
                      child: _buildField('Student Name', studentCtrl, ''),
                    ),
                    const SizedBox(width: 14),
                    Expanded(
                      child: _buildField('Student Roll No.', rollCtrl, ''),
                    ),
                  ],
                ),
                const SizedBox(height: 16),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        final name = studentCtrl.text.trim().isNotEmpty
                        ...
                        setState(() {
                          ...
                          record['rollNo'] = rollCtrl.text.trim().isNotEmpty
                              ? rollCtrl.text.trim()
                              : 'N/A';
                          record['age'] = ageCtrl.text.trim();
                          record['gender'] = gender;
                          record['issue'] = complaintCtrl.text.trim().isNotEmpty
                          ...
                          record['initials'] = initials.isNotEmpty
                              ? initials
                              : 'S';
                        });
                        Navigator.pop(context);
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Record a new infirmary visit or medical issue.',
                            style: TextStyle(
                              fontSize: 13,
                              color: Color(0xFF64748B),
                            ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        final initials = name
                            ...
                            .toUpperCase();
                        setState(() {
                          _healthRecords.insert(0, {
                            'id': DateTime.now().millisecondsSinceEpoch
                                .toString(),
                            'studentName': name,
                            'rollNo': rollCtrl.text.trim().isNotEmpty
                                ? rollCtrl.text.trim()
                                : 'N/A',
                            'roomNo': 'N/A',
                            'block': 'N/A',
                            'issue': complaintCtrl.text.trim().isNotEmpty
                                ? complaintCtrl.text.trim()
                                : 'General Checkup',
                            'severity': 'Low',
                            ...
                            'status': status,
                            'medication': treatmentCtrl.text.trim().isNotEmpty
                                ? treatmentCtrl.text.trim()
                                : 'N/A',
                            'doctor': 'N/A',
                            'notes': '',
                            'initials': initials.isNotEmpty ? initials : 'S',
                          });
                        });
                        Navigator.pop(context);
                      },
