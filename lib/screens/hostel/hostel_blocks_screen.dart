...
class _HostelBlocksScreenState extends State<HostelBlocksScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    int maintenanceBlocksCount = _blocks.where((b) => b['status'] == 'Maintenance' || b['status'] == 'Under Maintenance').length;
    ...
    final displayedBlocks = _blocks.where((b) {
      ...
      if (_filterType == 'Maintenance') matchesType = status == 'Maintenance' || status == 'Under Maintenance';
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(
                      child: Text('Hostel Blocks', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                    ),
                    ElevatedButton.icon(
                      onPressed: _showAddBlockModal,
                      icon: const Icon(LucideIcons.plus, size: 16, color: Colors.white),
                      label: const Text('Add Block', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.white)),
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        Expanded(
                          child: _buildKpiCard('Total Blocks', '$totalBlocksCount', LucideIcons.building, const Color(0xFF6C4CF1), const Color(0xFFF3F0FF), () {
                            setState(() => _filterType = 'All Types');
                          }),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: _buildKpiCard('Boys Blocks', '$boysBlocksCount', LucideIcons.user, const Color(0xFF3B82F6), const Color(0xFFEFF6FF), () {
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: _buildKpiCard('Girls Blocks', '$girlsBlocksCount', LucideIcons.user, const Color(0xFFEC4899), const Color(0xFFFDF2F8), () {
                            setState(() => _filterType = 'Girls');
                          }),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: _buildKpiCard('Under Maintenance', '$maintenanceBlocksCount', LucideIcons.wrench, const Color(0xFFF59E0B), const Color(0xFFFEF3C7), () {
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _filterType != 'All Types' ? const Color(0xFF6C4CF1) : Colors.white,
                          borderRadius: BorderRadius.circular(14),
                          border: Border.all(color: _filterType != 'All Types' ? const Color(0xFF6C4CF1) : const Color(0xFFE2E8F0)),
                        ),
                        child: Icon(
                          LucideIcons.slidersHorizontal,
                          color: _filterType != 'All Types' ? Colors.white : const Color(0xFF6C4CF1),
                          size: 20,
                        ),
                      ),
                    ),
                ...
                child: displayedBlocks.isEmpty
                    ? Center(
                        child: Padding(
                          ...
                          child: Text('No hostel blocks found', style: TextStyle(color: Colors.grey.shade500, fontSize: 15, fontWeight: FontWeight.w500)),
                        ),
                      )
                    : Column(
                        children: displayedBlocks.map((block) => _buildBlockCard(block)).toList(),
                      ),
              ),
  ...
  Widget _buildBlockCard(Map<String, dynamic> block) {
    ...
    final typeTextColor = isBoys ? const Color(0xFF2563EB) : const Color(0xFFDB2777);

    final status = (block['status'] ?? 'Active').toString();
    final isMaintenance = status == 'Maintenance' || status == 'Under Maintenance';
    final statusBg = isMaintenance ? const Color(0xFFFEF3C7) : const Color(0xFFDCFCE7);
    final statusTextColor = isMaintenance ? const Color(0xFFD97706) : const Color(0xFF16A34A);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text('${block['type']} Hostel', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: typeTextColor)),
                        ),
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (val) {
                  ...
                  if (val == 'rooms') MainLayout.pushSubScreen(context, HostelRoomsScreen(onBack: () => MainLayout.popSubScreen(context)));
                ...
                itemBuilder: (context) => [
                  ...
                  const PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        Icon(LucideIcons.doorOpen, size: 16, color: Color(0xFF10B981)),
                        SizedBox(width: 8),
                        Text('View Rooms', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
                      ],
                    ),
                  ),
                  const PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text('Edit Block', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
                      ],
                    ),
                  ),
                  const PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text('Delete Block', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFFE11D48))),
                      ],
                    ),
                  ),
                ],
          ...
          Row(
            children: [
              const Icon(LucideIcons.userCheck, size: 16, color: Color(0xFF6C4CF1)),
              const SizedBox(width: 8),
              Expanded(
                child: Text('Warden: ${block['warden']} (${block['contact']})', style: const TextStyle(fontSize: 12.5, fontWeight: FontWeight.w600, color: Color(0xFF334155))),
              ),
            ],
          ),
          const SizedBox(height: 12),
          ...
          Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const Text('Bed Occupancy', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF64748B))),
                  Text(
              ...
              ClipRRect(
                ...
                child: LinearProgressIndicator(
                  ...
                  valueColor: AlwaysStoppedAnimation<Color>(
                    occupancyPct > 0.9 ? const Color(0xFFE11D48) : const Color(0xFF6C4CF1),
                  ),
                ),
              ),
            ],
            ...
            Wrap(
              ...
              children: facilities.take(4).map((fac) {
                return Container(
                  ...
                  child: Text(fac, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Color(0xFF475569))),
                );
              }).toList(),
            ),
          ],
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text('Filter Blocks', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                  TextButton(
                    onPressed: () => setModalState(() => tempType = 'All Types'),
                    child: const Text('Reset', style: TextStyle(color: Color(0xFFE11D48), fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
              const SizedBox(height: 16),
              const Text('BLOCK TYPE', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF64748B))),
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    const Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Add New Block', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                          SizedBox(height: 4),
                          Text('Create a new hostel block or building in the system.', style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
                        ],
                      ),
                    ),
                    GestureDetector(
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Block Type', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                    const SizedBox(height: 6),
                    Container(
                ...
                // 4. Warden In-Charge
                _buildInputField('Warden In-Charge', wardenCtrl, 'e.g. Mr. Sharma'),
                const SizedBox(height: 16),

                // 5. Floors & Rooms in 2 Columns
                Row(
                  children: [
                    Expanded(child: _buildInputField('Floors', floorsCtrl, 'e.g. 4', isNum: true)),
                    const SizedBox(width: 14),
                    Expanded(child: _buildInputField('Rooms', roomsCtrl, 'e.g. 50', isNum: true)),
                  ],
                ),
                const SizedBox(height: 24),
                const Divider(color: Color(0xFFF1F5F9), height: 1),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        final code = codeCtrl.text.trim().isNotEmpty ? codeCtrl.text.trim().toUpperCase() : 'C';
                        final name = nameCtrl.text.trim().isNotEmpty ? nameCtrl.text.trim() : 'Chandragupta';
                        ...
                        setState(() {
                          _blocks.insert(0, {
                            ...
                            'code': code,
                            'type': selectedType,
                            'warden': wardenCtrl.text.trim().isNotEmpty ? wardenCtrl.text.trim() : 'Mr. Sharma',
                            ...
                            'facilities': ['Wi-Fi 24x7', 'Study Room', 'CCTV Security', 'Power Backup'],
                          });
                        });
                        Navigator.pop(context);
                      },
                      ...
                      child: const Text('Create Block', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
                    ),
                  ],
                ),
              ],
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text('Edit Hostel Block', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
              ...
              Row(
                children: [
                  Expanded(child: _buildInputField('Block Code', codeCtrl, 'Code')),
                  const SizedBox(width: 12),
                  Expanded(child: _buildInputField('Assigned Warden', wardenCtrl, 'Warden Name')),
                ],
              ),
              const SizedBox(height: 12),
              Row(
                children: [
                  Expanded(child: _buildInputField('Floors', floorsCtrl, '4', isNum: true)),
                  const SizedBox(width: 10),
                  Expanded(child: _buildInputField('Rooms', roomsCtrl, '40', isNum: true)),
                  const SizedBox(width: 10),
                  Expanded(child: _buildInputField('Total Beds', bedsCtrl, '160', isNum: true)),
                ],
              ),
              const SizedBox(height: 12),
                ...
                child: ElevatedButton(
                  onPressed: () {
                    setState(() {
                      ...
                      block['floors'] = int.tryParse(floorsCtrl.text) ?? block['floors'];
                      block['rooms'] = int.tryParse(roomsCtrl.text) ?? block['rooms'];
                      block['totalBeds'] = int.tryParse(bedsCtrl.text) ?? block['totalBeds'];
                    });
                    Navigator.pop(context);
                  },
                  style: ElevatedButton.styleFrom(
                  ...
                  child: const Text('Save Changes', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white)),
                ),
              ),
            ],
          ),
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('Block Overview', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                    IconButton(icon: const Icon(Icons.close, color: Color(0xFF6C4CF1), size: 20), onPressed: () => Navigator.pop(context)),
                  ],
                ),
              ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('${block['name']}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                          Text('${block['type']} Hostel • Code: ${block['code']}', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: Color(0xFF6C6C80))),
                        ],
                      ),
                    ),
                  ],
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('BLOCK CAPACITY & OCCUPANCY', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF64748B), letterSpacing: 0.5)),
                    const SizedBox(height: 10),
                    Row(
                      children: [
                        Expanded(child: _buildDetailGridItem('TOTAL FLOORS', '${block['floors']} Floors')),
                        Expanded(child: _buildDetailGridItem('TOTAL ROOMS', '${block['rooms']} Rooms')),
                      ],
                    ),
                    const SizedBox(height: 14),
                    Row(
                      children: [
                        Expanded(child: _buildDetailGridItem('TOTAL BEDS', '$totalBeds Beds')),
                        Expanded(child: _buildDetailGridItem('OCCUPIED BEDS', '$occupiedBeds ($availableBeds Free)')),
                      ],
                    ),
                    const SizedBox(height: 20),

                    const Text('MANAGEMENT & WARDEN', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF64748B), letterSpacing: 0.5)),
                    const SizedBox(height: 10),
                    Row(
                      children: [
                        Expanded(child: _buildDetailGridItem('HEAD WARDEN', '${block['warden']}')),
                        Expanded(child: _buildDetailGridItem('CONTACT PHONE', '${block['contact']}')),
                      ],
                    ),
                    const SizedBox(height: 20),

                    const Text('FACILITIES & AMENITIES', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF64748B), letterSpacing: 0.5)),
                    const SizedBox(height: 10),
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: facilities.map((fac) {
                        return Container(
                          ...
                          child: Text(fac, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF334155))),
                        );
                      }).toList(),
                    ),
                  ],
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Delete ${block['name']}?', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
            const SizedBox(height: 8),
            const Text('Are you sure you want to delete this block? This action cannot be undone.', textAlign: TextAlign.center, style: TextStyle(color: Color(0xFF64748B), fontSize: 13)),
            const SizedBox(height: 24),
            Row(
              children: [
                Expanded(
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: const Text('Delete Block', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
