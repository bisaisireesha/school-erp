...
class _HostelVisitorsScreenState extends State<HostelVisitorsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    int rejectedCount = _visitorsList.where((v) => v['status'] == 'Rejected').length;
    ...
    final displayedVisitors = _visitorsList.where((item) {
      ...
      bool matchesQuery = query.isEmpty || name.contains(query) || student.contains(query) || rollNo.contains(query);
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(
                      child: Text('Hostel Visitors', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                    ),
                    GestureDetector(
                    ...
                    ElevatedButton.icon(
                      ...
                      label: const Text('Log Visitor', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.white)),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        Expanded(child: _buildKpiCard('Total Visitors Today', '$totalVisitors', LucideIcons.users, const Color(0xFF6C4CF1), const Color(0xFFF3F0FF))),
                        const SizedBox(width: 12),
                        Expanded(child: _buildKpiCard('Currently Inside', '$currentlyInsideCount', LucideIcons.circleCheckBig, const Color(0xFF10B981), const Color(0xFFF0FDF4))),
                      ],
                    ),
                    const SizedBox(height: 12),
                    Row(
                      children: [
                        Expanded(child: _buildKpiCard('Pending Approval', '$pendingCount', LucideIcons.clock, const Color(0xFFF59E0B), const Color(0xFFFEF3C7))),
                        const SizedBox(width: 12),
                        Expanded(child: _buildKpiCard('Rejected', '$rejectedCount', LucideIcons.circleX, const Color(0xFFE11D48), const Color(0xFFFEE2E2))),
                      ],
                    ),
                  ],
                ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: const Icon(LucideIcons.x, size: 14, color: Color(0xFF6C4CF1)),
                        ),
                      ],
                    ),
                  ),
                ...
                child: displayedVisitors.isEmpty
                    ? Center(
                        child: Padding(
                          ...
                          child: Text('No visitor records found', style: TextStyle(color: Colors.grey.shade500, fontSize: 15, fontWeight: FontWeight.w500)),
                        ),
                      )
                    : Column(
                        children: displayedVisitors.map((visitor) => _buildVisitorCard(visitor)).toList(),
                      ),
              ),
  ...
  void _showFilterBottomSheet() {
    showModalBottomSheet(
      ...
      builder: (context) {
        final filters = [
          {'label': 'All Visitors', 'value': 'All', 'icon': LucideIcons.users, 'color': const Color(0xFF6C4CF1)},
          {'label': 'Currently Inside', 'value': 'Currently Inside', 'icon': LucideIcons.circleCheckBig, 'color': const Color(0xFF10B981)},
          {'label': 'Pending Approval', 'value': 'Pending Approval', 'icon': LucideIcons.clock, 'color': const Color(0xFFF59E0B)},
          {'label': 'Checked Out', 'value': 'Checked Out', 'icon': LucideIcons.logOut, 'color': const Color(0xFF3B82F6)},
          {'label': 'Rejected', 'value': 'Rejected', 'icon': LucideIcons.circleX, 'color': const Color(0xFFE11D48)},
        ];
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Expanded(child: Text('Filter Visitors', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D)))),
                  GestureDetector(
                    onTap: () => Navigator.pop(context),
                    child: const Padding(padding: EdgeInsets.all(4), child: Icon(LucideIcons.x, color: Color(0xFF64748B), size: 20)),
                  ),
                ],
              ),
              const SizedBox(height: 6),
              const Text('Select a status to filter visitor list', style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(14),
                      border: Border.all(color: isActive ? const Color(0xFF6C4CF1) : const Color(0xFFE2E8F0)),
                    ),
                    child: Row(
                      children: [
                ...
                onSelected: (val) {
                  ...
                  if (val == 'checkout') {
                    setState(() {
                      ...
                      visitor['checkOut'] = '${hour.toString().padLeft(2, '0')}:${now.minute.toString().padLeft(2, '0')} $period';
                    });
                  }
                  if (val == 'approve') {
                    setState(() {
                      ...
                      final hour = now.hourOfPeriod == 0 ? 12 : now.hourOfPeriod;
                      final period = now.period == DayPeriod.am ? 'AM' : 'PM';
                      visitor['checkIn'] = '${hour.toString().padLeft(2, '0')}:${now.minute.toString().padLeft(2, '0')} $period';
                    });
                  }
                  if (val == 'delete') {
                    setState(() {
                      _visitorsList.removeWhere((v) => v['id'] == visitor['id']);
                    });
                  }
                },
                itemBuilder: (context) => [
                  const PopupMenuItem(
                    value: 'view',
                    child: Row(children: [Icon(LucideIcons.eye, size: 16, color: Color(0xFF6C4CF1)), SizedBox(width: 8), Text('View Details', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600))]),
                  ),
                  if (status == 'Currently Inside')
                    const PopupMenuItem(
                      value: 'checkout',
                      child: Row(children: [Icon(LucideIcons.logOut, size: 16, color: Color(0xFFF59E0B)), SizedBox(width: 8), Text('Mark Checked Out', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600))]),
                    ),
                  if (status == 'Pending Approval')
                    const PopupMenuItem(
                      value: 'approve',
                      child: Row(children: [Icon(LucideIcons.userCheck, size: 16, color: Color(0xFF10B981)), SizedBox(width: 8), Text('Approve & Check In', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600))]),
                    ),
                  const PopupMenuItem(
                    value: 'delete',
                    child: Row(children: [Icon(LucideIcons.trash2, size: 16, color: Color(0xFFE11D48)), SizedBox(width: 8), Text('Delete', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFFE11D48)))]),
                  ),
                ],
              ),
            ],
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(child: _buildInfoItem(LucideIcons.phone, 'Phone', visitor['phone'] as String, const Color(0xFF10B981))),
                    Expanded(child: _buildInfoItem(LucideIcons.heart, 'Relation', visitor['relation'] as String, const Color(0xFFE11D48))),
                  ],
                ),
                const SizedBox(height: 12),
                // Row 2: Purpose
                _buildInfoItem(LucideIcons.fileText, 'Purpose', visitor['purpose'] as String, const Color(0xFF6C4CF1)),
                const SizedBox(height: 12),
                // Row 3: Student Name + Roll No
                Row(
                  children: [
                    Expanded(child: _buildInfoItem(LucideIcons.graduationCap, 'Student', visitor['studentName'] as String, const Color(0xFF3B82F6))),
                    Expanded(child: _buildInfoItem(LucideIcons.hash, 'Roll No.', visitor['rollNo'] as String, const Color(0xFF8B5CF6))),
                  ],
                ),
                const SizedBox(height: 12),
                ...
                Row(
                  children: [
                    Expanded(child: _buildInfoItem(LucideIcons.logIn, 'Check-in', visitor['checkIn'] as String, const Color(0xFF10B981))),
                    Expanded(child: _buildInfoItem(LucideIcons.logOut, 'Check-out', visitor['checkOut'] as String, const Color(0xFF2563EB))),
                  ],
                ),
              ],
            ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(value, style: const TextStyle(fontSize: 12.5, fontWeight: FontWeight.w600, color: Color(0xFF334155)), overflow: TextOverflow.ellipsis),
            ],
          ),
        ),
      ],
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      const Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Log New Visitor', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                            SizedBox(height: 4),
                            Text('Record details for a new visitor entering the premises.', style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
                          ],
                        ),
                      ),
                      GestureDetector(
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildModalField('Visitor Name', nameCtrl, 'Enter name')),
                      const SizedBox(width: 14),
                      Expanded(child: _buildModalField('Phone Number', phoneCtrl, 'Enter phone', isNum: true)),
                    ],
                  ),
                  const SizedBox(height: 18),
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildModalField('Relation', relationCtrl, 'e.g. Father')),
                      const SizedBox(width: 14),
                      Expanded(child: _buildModalField('Purpose of Visit', purposeCtrl, 'e.g. Family Visit')),
                    ],
                  ),
                  const SizedBox(height: 18),
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildModalField('Student Name', studentCtrl, 'Enter student name')),
                      const SizedBox(width: 14),
                      Expanded(child: _buildModalField('Student Roll No.', rollNoCtrl, 'e.g. CS-2024-102')),
                    ],
                  ),
                  const SizedBox(height: 18),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Check-in Time', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                      const SizedBox(height: 6),
                      GestureDetector(
                        onTap: () async {
                              ...
                              return Theme(
                                data: Theme.of(context).copyWith(
                                  ...
                                  timePickerTheme: TimePickerThemeData(
                                    ...
                                    hourMinuteTextColor: const Color(0xFF6C4CF1),
                                    ...
                                    helpTextStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF6C4CF1)),
                                  ),
                                ),
                                child: child!,
                              );
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Text(timeStr, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFF1E1E2D))),
                              const Spacer(),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          ...
                          child: const Text('Cancel', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                        ),
                      ),
                      const SizedBox(width: 14),
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            final name = nameCtrl.text.trim().isNotEmpty ? nameCtrl.text.trim() : 'Mr. New Visitor';
                            ...
                            final prd = selectedTime.period == DayPeriod.am ? 'AM' : 'PM';
                            final checkInTime = '${h.toString().padLeft(2, '0')}:${selectedTime.minute.toString().padLeft(2, '0')} $prd';

                            setState(() {
                              _visitorsList.insert(0, {
                                'id': DateTime.now().millisecondsSinceEpoch.toString(),
                                'name': name,
                                'phone': phoneCtrl.text.trim().isNotEmpty ? phoneCtrl.text.trim() : '+91 00000 00000',
                                'relation': relationCtrl.text.trim().isNotEmpty ? relationCtrl.text.trim() : 'Parent',
                                'purpose': purposeCtrl.text.trim().isNotEmpty ? purposeCtrl.text.trim() : 'Visit',
                                'studentName': studentCtrl.text.trim().isNotEmpty ? studentCtrl.text.trim() : 'Student',
                                'rollNo': rollNoCtrl.text.trim().isNotEmpty ? rollNoCtrl.text.trim() : 'N/A',
                                'checkIn': checkInTime,
                                'checkOut': '--',
                                'status': 'Currently Inside',
                          ...
                          child: const Text('Save Log', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white)),
                        ),
                      ),
                    ],
                  ),
  ...
  Widget _buildModalField(String label, TextEditingController controller, String hint, {bool isNum = false}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
            ...
            Row(
              children: [
                CircleAvatar(
                  radius: 22,
                  backgroundColor: const Color(0xFFF3F0FF),
                  child: Text(visitor['initials'] as String, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF6C4CF1))),
                ),
                const SizedBox(width: 14),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(visitor['name'] as String, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E1E2D))),
                      const SizedBox(height: 2),
                      Text('Status: ${visitor['status']}', style: const TextStyle(fontSize: 12.5, fontWeight: FontWeight.bold, color: Color(0xFF6C4CF1))),
                    ],
                  ),
                ),
