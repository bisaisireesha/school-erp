...
class _HostelWardensScreenState extends State<HostelWardensScreen> {
  String _searchQuery = '';
  String _filterRole =
      'All Roles'; // All Roles, Head Warden, Assistant Warden, Night Warden
// ignore: unused_field
  ...
  Future<void> _loadWardens() async {
    try {
      final String response = await rootBundle.loadString(
        'assets/mock/hostel_wardens.json',
      );
            ...
            children: [
              ...
              Padding(
                ...
                child: displayedWardens.isEmpty
                    ...
                    : Column(
                        children: displayedWardens
                            .map((warden) => _buildWardenCard(warden))
                            .toList(),
                      ),
              ),
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        if (warden['blockCode'] != null &&
                            warden['blockCode'].toString().isNotEmpty)
                          TextSpan(
                            text: ' (${warden['blockCode']})',
                            style: const TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Color(0xFF6C4CF1),
                            ),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () =>
                        setModalState(() => tempRole = 'All Roles'),
                    child: const Text(
                      'Reset',
                      style: TextStyle(
                        color: Color(0xFFE11D48),
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Register a new hostel warden and assign them to a block.',
                            style: TextStyle(
                              fontSize: 13,
                              color: Color(0xFF64748B),
                            ),
                      ...
                      onPressed: () {
                        if (nameCtrl.text.isNotEmpty ||
                          ...
                          final name = nameCtrl.text.trim().isNotEmpty
                              ? nameCtrl.text.trim()
                              : 'Mr. R. Sharma';
                          final code = blockCodeCtrl.text.trim().isNotEmpty
                              ? blockCodeCtrl.text.trim().toUpperCase()
                              : 'A';
                          final blockName = blockCtrl.text.trim().isNotEmpty
                              ? blockCtrl.text.trim()
                              : 'Aryabhata Block ($code)';
                          final initials = name
                              .split(' ')
                          ...
                          setState(() {
                            _wardens.insert(0, {
                              ...
                              'role': 'Head Warden',
                              'block': blockName.contains('Block')
                                  ? blockName
                              ...
                              'experience': expCtrl.text.trim().isNotEmpty
                                  ? '${expCtrl.text.trim()} Years'
                                  : '5 Years',
                              'gender': selectedType == 'Girls'
                                  ? 'Female'
                                  : 'Male',
  ...
  void _showEditWardenModal(Map<String, dynamic> warden) {
    ...
    final expCtrl = TextEditingController(
      text: '${warden['experience']}'.replaceAll(' Years', ''),
    );
    ...
    String selectedShift = warden['shift'].toString().contains('Night')
        ? 'Night'
        : (warden['shift'].toString().contains('Evening')
              ? 'Evening'
              : 'Morning');
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Update warden profile details and block assignment.',
                            style: TextStyle(
                              fontSize: 13,
                              color: Color(0xFF64748B),
                            ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        setState(() {
                          warden['name'] = nameCtrl.text.trim().isNotEmpty
                              ? nameCtrl.text.trim()
                              : warden['name'];
                          warden['block'] = blockCtrl.text.trim().isNotEmpty
                              ? blockCtrl.text.trim()
                              : warden['block'];
                          warden['blockCode'] =
                              blockCodeCtrl.text.trim().isNotEmpty
                              ? blockCodeCtrl.text.trim()
                              : warden['blockCode'];
                          warden['phone'] = phoneCtrl.text.trim().isNotEmpty
                              ? phoneCtrl.text.trim()
                              : warden['phone'];
                          warden['email'] = emailCtrl.text.trim().isNotEmpty
                              ? emailCtrl.text.trim()
                              : warden['email'];
                          warden['shift'] = '$selectedShift Shift';
                          warden['experience'] = expCtrl.text.trim().isNotEmpty
                              ? '${expCtrl.text.trim()} Years'
                              : warden['experience'];
                          warden['gender'] = selectedType == 'Girls'
                              ? 'Female'
                              : 'Male';
                        });
                        Navigator.pop(context);
                    ...
                    CircleAvatar(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: _getColor(warden['color'] as String),
                        ),
                      ),
                    ),
                    const SizedBox(width: 16),
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'Are you sure you want to remove this warden from the system?',
