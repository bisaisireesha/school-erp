...
class _VisitorsScreenState extends State<VisitorsScreen> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> displayedVisitors = _visitors.where((visitor) {
      ...
      if (_selectedFilter == 2 && visitor['status'] != 'Completed') {
        return false;
      }
              ...
              if (displayedVisitors.isEmpty)
                const Padding(
                  ...
                  child: Center(
                    child: Text(
                      'No visitors found.',
                      style: TextStyle(color: Color(0xFF4A4A68), fontSize: 14),
                    ),
                  ),
                )
              else
                            ...
                            onSelected: (value) {
                              if (value == 'delete') {
                                ...
                                setState(() {
                                  ...
                                  visitor['timeOut'] = TimeOfDay.now().format(
                                    context,
                                  );
                                });
                                ScaffoldMessenger.of(context).showSnackBar(
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      '$value action selected for ${visitor['name']}',
                                    ),
                                  ),
                                );
                              }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        label: Text(
                          isEdit ? 'Save Changes' : 'Log Visitor',
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 16,
