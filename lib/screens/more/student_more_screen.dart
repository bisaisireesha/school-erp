  ...
  void _handleTap(BuildContext context, String key) {
    switch (key) {
      ...
      case 'Transport':
        ...
        break;
      case 'Study Material':
        MainLayout.pushSubScreen(context, ResourcesScreen(onBack: () => MainLayout.popSubScreen(context)));
        break;
      case 'Calendar':
        MainLayout.pushSubScreen(context, CalendarScreen(onBack: () => MainLayout.popSubScreen(context)));
        break;
      case 'CCTV':
        MainLayout.pushSubScreen(context, CCTVScreen(onBack: () => MainLayout.popSubScreen(context)));
        break;
    }
  }
}
